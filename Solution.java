...
public class Solution {
    public static void main(String args[] ) throws Exception {
        ...
        for(int i=0;i<testCases;i++) {
        	Solution.TestCase testCase = a.new TestCase();
            ...
            Map<Solution.Location,Integer> nonZeroElements = new HashMap<Solution.Location,Integer>();
            for(String command: commands) {
            	...
            	if("UPDATE".equalsIgnoreCase(commandElems[0])) {
            		...
            		Solution.Location loc = a.new Location(x,y,z);            		
